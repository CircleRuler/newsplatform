...
Template["lists"] = new Template("Template.lists", (function() {                                                   // 3
  ...
  return HTML.OL("\n    ", HTML.TABLE({                                                                            // 5
    ...
    return Spacebars.call(view.lookup("lists"));                                                                   // 10
  }, function() {                                                                                                  // 11
    return [ "\n                ", HTML.TR("\n                    ", HTML.TH(), "\n                    ", HTML.TD(HTML.LI()), "\n                    ", HTML.TD(Blaze.View("lookup:user.username", function() {
      return Spacebars.mustache(Spacebars.dot(view.lookup("user"), "username"));                                   // 13
    })), "\n                    ", HTML.TD(Blaze.View("lookup:rank", function() {                                  // 14
      return Spacebars.mustache(view.lookup("rank"));                                                              // 15
    })), "\n                    ", HTML.TD(Blaze.View("lookup:totalScore", function() {                            // 16
      return Spacebars.mustache(view.lookup("totalScore"));                                                        // 17
    })), "\n                "), "\n            " ];                                                                // 18
  }), "\n        "), "\n    "), "\n    ");                                                                         // 19
}));                                                                                                               // 20
                                                                                                                   // 21
...
Template.lists.helpers({                                                                                           // 41
    lists: function () {                                                                                           // 42
        function lists() {                                                                                         //
            return UserInfo.find({}, { sort: { totalScore: 1 } });                                                 // 43
        }                                                                                                          //
                                                                                                                   //
        return lists;                                                                                              //
    }()                                                                                                            //
...
var urlRouter = Backbone.Router.extend({                                                                           // 64
    ...
    index: function () {                                                                                           // 74
        function index() {                                                                                         // 74
            Session.set("currentUrl", { index: "active", login: "", reg: "", friend: "", lists: "", self: "" });   // 75
        }                                                                                                          //
                                                                                                                   //
        return index;                                                                                              //
    }(),                                                                                                           //
    friend: function () {                                                                                          // 77
        function friend() {                                                                                        // 77
            Session.set("currentUrl", { index: "", login: "", reg: "", friend: "active", lists: "", self: "" });   // 78
        }                                                                                                          //
                                                                                                                   //
        return friend;                                                                                             //
    }(),                                                                                                           //
    lists: function () {                                                                                           // 80
        function lists() {                                                                                         // 80
            Session.set("currentUrl", { index: "", login: "", reg: "", friend: "", lists: "active", self: "" });   // 81
        }                                                                                                          //
                                                                                                                   //
        return lists;                                                                                              //
    }(),                                                                                                           //
    self: function () {                                                                                            // 83
        function self() {                                                                                          // 83
            Session.set("currentUrl", { index: "", login: "", reg: "", friend: "", lists: "", self: "active" });   // 84
        }                                                                                                          //
                                                                                                                   //
        return self;                                                                                               //
    }(),                                                                                                           //
    login: function () {                                                                                           // 86
        function login() {                                                                                         // 86
            ...
            Session.set("currentUrl", { index: "", login: "active", reg: "", friend: "", lists: "", self: "" });   // 91
        }                                                                                                          //
                                                                                                                   //
        return login;                                                                                              //
    }(),                                                                                                           //
    reg: function () {                                                                                             // 93
        function reg() {                                                                                           // 93
            ...
            Session.set("currentUrl", { index: "", login: "", reg: "active", friend: "", lists: "", self: "" });   // 98
        }                                                                                                          //
                                                                                                                   //
        return reg;                                                                                                //
    }(),                                                                                                           //
...
Template.index.events({                                                                                            // 183
    'click #submit': function () {                                                                                 // 184
        function clickSubmit(event) {                                                                              // 184
            ...
            Posts.insert({                                                                                         // 191
                ...
                Likers: [],                                                                                        // 196
                top: false,                                                                                        // 197
                time: new Date() }, function (err) {                                                               // 198
                if (err) {                                                                                         // 200
                    Session.set("info", { success: "", error: "发表失败" });                                           // 201
                } else {                                                                                           //
                    Session.set("info", { success: "发表成功", error: "" });                                           // 203
                    $("#post").val("");                                                                            // 204
                }                                                                                                  //
            });                                                                                                    //
            SystemInfo.update({ "_id": "1" }, { $inc: { "totalPost": 1 } });                                       // 208
        }                                                                                                          //
                                                                                                                   //
        return clickSubmit;                                                                                        //
    }(),                                                                                                           //
    'click #commnetSubmit': function () {                                                                          // 210
        function clickCommnetSubmit(event) {                                                                       // 210
            event.preventDefault();                                                                                // 211
            var $comment = $("#" + this._id).val();                                                                // 212
            if ($comment.length === 0 || $comment.length >= 100) {                                                 // 213
                Session.set("info", { success: "", error: "请将字数限制在1-100字以内" });                                    // 214
                scroll(0, 0);                                                                                      // 215
                return;                                                                                            // 216
            }                                                                                                      //
            Posts.insert({                                                                                         // 218
                user: Meteor.user(),                                                                               // 219
                post: $comment,                                                                                    // 220
                "super": this._id,                                                                                 // 221
                time: new Date() }, function (err) {                                                               // 222
                if (err) {                                                                                         // 224
                    Session.set("info", { success: "", error: "评论失败" });                                           // 225
                } else {                                                                                           //
                    Session.set("info", { success: "评论成功", error: "" });                                           // 227
                    $("#" + this._id).val("");                                                                     // 228
                }                                                                                                  //
            });                                                                                                    //
            SystemInfo.update({ "_id": "1" }, { $inc: { "totalPost": 1 } });                                       // 232
        }                                                                                                          //
                                                                                                                   //
        return clickCommnetSubmit;                                                                                 //
    }(),                                                                                                           //
    'click #addFriend': function () {                                                                              // 234
        function clickAddFriend(event) {                                                                           // 234
            event.preventDefault();                                                                                // 235
            var $friendId = this.user._id;                                                                         // 236
            if (UserInfo.findOne({ "user._id": Meteor.userId(), "Friends": $friendId })) {                         // 237
                Session.set("info", { success: "", error: "错误：此好友已经存在" });                                         // 238
                scroll(0, 0);                                                                                      // 239
                return;                                                                                            // 240
            }                                                                                                      //
                                                                                                                   //
            var userInfoId = UserInfo.findOne({ "user._id": Meteor.userId() })._id;                                // 243
            UserInfo.update({                                                                                      // 244
                "_id": userInfoId                                                                                  // 245
            }, {                                                                                                   //
                $addToSet: { "Friends": $friendId },                                                               // 247
                $inc: { "totalFriend": 1 }                                                                         // 248
            }, true, true, function (err) {                                                                        //
                if (err) {                                                                                         // 252
                    Session.set("info", { success: "", error: "添加好友失败" });                                         // 253
                } else {                                                                                           //
                    Session.set("info", { success: "添加成功", error: "" });                                           // 255
                }                                                                                                  //
            });                                                                                                    //
        }                                                                                                          //
                                                                                                                   //
    ...
    'click #likePost': function () {                                                                               // 260
        function clickLikePost(event) {                                                                            // 260
            event.preventDefault();                                                                                // 261
            if (Posts.findOne({ "_id": this._id, "Likers": Meteor.userId() })) {                                   // 262
                Session.set("info", { success: "", error: "错误：您已经点过赞" });                                          // 263
                scroll(0, 0);                                                                                      // 264
                return;                                                                                            // 265
            }                                                                                                      //
            Posts.update({                                                                                         // 267
                ...
                $addToSet: { "Likers": Meteor.userId() },                                                          // 270
                $inc: { "like": 1 }                                                                                // 271
            }, false, true, function (err) {                                                                       //
                if (err) {                                                                                         // 275
                    Session.set("info", { success: "", error: "点赞失败" });                                           // 276
                } else {                                                                                           //
                    Session.set("info", { success: "点赞成功", error: "" });                                           // 278
                }                                                                                                  //
            });                                                                                                    //
        }                                                                                                          //
                                                                                                                   //
    ...
    'click #topPost': function () {                                                                                // 283
        function clickTopPost(event) {                                                                             // 283
            event.preventDefault();                                                                                // 284
            if (Meteor.user().username != "admin") {                                                               // 285
                Session.set("info", { success: "", error: "错误：您并非管理员。" });                                         // 286
                scroll(0, 0);                                                                                      // 287
                return;                                                                                            // 288
            }                                                                                                      //
            Posts.update({                                                                                         // 290
                ...
                if (err) {                                                                                         // 297
                    Session.set("info", { success: "", error: "置顶失败" });                                           // 298
                } else {                                                                                           //
                    Session.set("info", { success: "置顶成功", error: "" });                                           // 300
                }                                                                                                  //
            });                                                                                                    //
        }                                                                                                          //
                                                                                                                   //
    ...
    'click #untopPost': function () {                                                                              // 305
        function clickUntopPost(event) {                                                                           // 305
            event.preventDefault();                                                                                // 306
            if (Meteor.user().username != "admin") {                                                               // 307
                Session.set("info", { success: "", error: "错误：您并非管理员。" });                                         // 308
                scroll(0, 0);                                                                                      // 309
                return;                                                                                            // 310
            }                                                                                                      //
            Posts.update({                                                                                         // 312
                ...
                if (err) {                                                                                         // 319
                    Session.set("info", { success: "", error: "取消置顶失败" });                                         // 320
                } else {                                                                                           //
                    Session.set("info", { success: "取消置顶成功", error: "" });                                         // 322
                }                                                                                                  //
            });                                                                                                    //
        }                                                                                                          //
                                                                                                                   //
