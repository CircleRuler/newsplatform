...
install("url");                                                                                              // 95
install("http");                                                                                             // 96
install("cfs:data-man");                                                                                     // 97
install("cfs:file");                                                                                         // 98
install("cfs:tempstore");                                                                                    // 99
install("cfs:http-methods");                                                                                 // 100
install("cfs:http-publish");                                                                                 // 101
install("cfs:access-point");                                                                                 // 102
install("cfs:reactive-property");                                                                            // 103
install("cfs:reactive-list");                                                                                // 104
install("cfs:power-queue");                                                                                  // 105
install("cfs:upload-http");                                                                                  // 106
install("cfs:collection");                                                                                   // 107
install("cfs:collection-filters");                                                                           // 108
install("cfs:worker");                                                                                       // 109
install("autoupdate");                                                                                       // 110
install("service-configuration");                                                                            // 111
                                                                                                             // 112
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
