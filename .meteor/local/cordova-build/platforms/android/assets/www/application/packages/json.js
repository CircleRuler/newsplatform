...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                               //
// packages/json/packages/json.js                                                                                //
//                                                                                                               //
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                 //
(function () {                                                                                                   // 1
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////     // 3
//                                                                                                        //     // 4
// packages/json/json_native.js                                                                           //     // 5
//                                                                                                        //     // 6
////////////////////////////////////////////////////////////////////////////////////////////////////////////     // 7
                                                                                                          //     // 8
// Do we already have a global JSON object? Export it as our JSON object.                                 // 1   // 9
if (window.JSON)                                                                                          // 2   // 10
  JSON = window.JSON;                                                                                     // 3   // 11
                                                                                                          // 4   // 12
////////////////////////////////////////////////////////////////////////////////////////////////////////////     // 13
                                                                                                                 // 14
}).call(this);                                                                                                   // 15
...
/*                                                                                                        // 1   // 30
    ...
    Public Domain.                                                                                        // 5   // 34
                                                                                                          // 6   // 35
    NO WARRANTY EXPRESSED OR IMPLIED. USE AT YOUR OWN RISK.                                               // 7   // 36
                                                                                                          // 8   // 37
    See http://www.JSON.org/js.html                                                                       // 9   // 38
                                                                                                          // 10  // 39
                                                                                                          // 11  // 40
    This code should be minified before deployment.                                                       // 12  // 41
    See http://javascript.crockford.com/jsmin.html                                                        // 13  // 42
                                                                                                          // 14  // 43
    USE YOUR OWN COPY. IT IS EXTREMELY UNWISE TO LOAD CODE FROM SERVERS YOU DO                            // 15  // 44
    NOT CONTROL.                                                                                          // 16  // 45
                                                                                                          // 17  // 46
                                                                                                          // 18  // 47
    This file creates a global JSON object containing two methods: stringify                              // 19  // 48
    and parse.                                                                                            // 20  // 49
                                                                                                          // 21  // 50
        JSON.stringify(value, replacer, space)                                                            // 22  // 51
            value       any JavaScript value, usually an object or array.                                 // 23  // 52
                                                                                                          // 24  // 53
            replacer    an optional parameter that determines how object                                  // 25  // 54
                        values are stringified for objects. It can be a                                   // 26  // 55
                        function or an array of strings.                                                  // 27  // 56
                                                                                                          // 28  // 57
            space       an optional parameter that specifies the indentation                              // 29  // 58
                        of nested structures. If it is omitted, the text will                             // 30  // 59
                        be packed without extra whitespace. If it is a number,                            // 31  // 60
                        it will specify the number of spaces to indent at each                            // 32  // 61
                        level. If it is a string (such as '\t' or '&nbsp;'),                              // 33  // 62
                        it contains the characters used to indent at each level.                          // 34  // 63
                                                                                                          // 35  // 64
            This method produces a JSON text from a JavaScript value.                                     // 36  // 65
                                                                                                          // 37  // 66
            When an object value is found, if the object contains a toJSON                                // 38  // 67
            method, its toJSON method will be called and the result will be                               // 39  // 68
            stringified. A toJSON method does not serialize: it returns the                               // 40  // 69
            value represented by the name/value pair that should be serialized,                           // 41  // 70
            or undefined if nothing should be serialized. The toJSON method                               // 42  // 71
            will be passed the key associated with the value, and this will be                            // 43  // 72
            bound to the value                                                                            // 44  // 73
                                                                                                          // 45  // 74
            For example, this would serialize Dates as ISO strings.                                       // 46  // 75
                                                                                                          // 47  // 76
                Date.prototype.toJSON = function (key) {                                                  // 48  // 77
                    function f(n) {                                                                       // 49  // 78
                        // Format integers to have at least two digits.                                   // 50  // 79
                        return n < 10 ? '0' + n : n;                                                      // 51  // 80
                    }                                                                                     // 52  // 81
                                                                                                          // 53  // 82
                    return this.getUTCFullYear()   + '-' +                                                // 54  // 83
                         f(this.getUTCMonth() + 1) + '-' +                                                // 55  // 84
                         f(this.getUTCDate())      + 'T' +                                                // 56  // 85
                         f(this.getUTCHours())     + ':' +                                                // 57  // 86
                         f(this.getUTCMinutes())   + ':' +                                                // 58  // 87
                         f(this.getUTCSeconds())   + 'Z';                                                 // 59  // 88
                };                                                                                        // 60  // 89
                                                                                                          // 61  // 90
            You can provide an optional replacer method. It will be passed the                            // 62  // 91
            key and value of each member, with this bound to the containing                               // 63  // 92
            object. The value that is returned from your method will be                                   // 64  // 93
            serialized. If your method returns undefined, then the member will                            // 65  // 94
            be excluded from the serialization.                                                           // 66  // 95
                                                                                                          // 67  // 96
            If the replacer parameter is an array of strings, then it will be                             // 68  // 97
            used to select the members to be serialized. It filters the results                           // 69  // 98
            such that only members with keys listed in the replacer array are                             // 70  // 99
            stringified.                                                                                  // 71  // 100
                                                                                                          // 72  // 101
            Values that do not have JSON representations, such as undefined or                            // 73  // 102
            functions, will not be serialized. Such values in objects will be                             // 74  // 103
            dropped; in arrays they will be replaced with null. You can use                               // 75  // 104
            a replacer function to replace those with JSON values.                                        // 76  // 105
            JSON.stringify(undefined) returns undefined.                                                  // 77  // 106
                                                                                                          // 78  // 107
            The optional space parameter produces a stringification of the                                // 79  // 108
            value that is filled with line breaks and indentation to make it                              // 80  // 109
            easier to read.                                                                               // 81  // 110
                                                                                                          // 82  // 111
            If the space parameter is a non-empty string, then that string will                           // 83  // 112
            be used for indentation. If the space parameter is a number, then                             // 84  // 113
            the indentation will be that many spaces.                                                     // 85  // 114
                                                                                                          // 86  // 115
            Example:                                                                                      // 87  // 116
                                                                                                          // 88  // 117
            text = JSON.stringify(['e', {pluribus: 'unum'}]);                                             // 89  // 118
            // text is '["e",{"pluribus":"unum"}]'                                                        // 90  // 119
                                                                                                          // 91  // 120
                                                                                                          // 92  // 121
            text = JSON.stringify(['e', {pluribus: 'unum'}], null, '\t');                                 // 93  // 122
            // text is '[\n\t"e",\n\t{\n\t\t"pluribus": "unum"\n\t}\n]'                                   // 94  // 123
                                                                                                          // 95  // 124
            text = JSON.stringify([new Date()], function (key, value) {                                   // 96  // 125
                return this[key] instanceof Date ?                                                        // 97  // 126
                    'Date(' + this[key] + ')' : value;                                                    // 98  // 127
            });                                                                                           // 99  // 128
