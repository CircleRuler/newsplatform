...
install("bootstrap");                                                                                        // 62
install("json");                                                                                             // 63
install("backbone");                                                                                         // 64
install("npm-bcrypt");                                                                                       // 65
install("ddp-rate-limiter");                                                                                 // 66
install("localstorage");                                                                                     // 67
install("callback-hook");                                                                                    // 68
install("deps");                                                                                             // 69
install("htmljs");                                                                                           // 70
...
install("sha");                                                                                              // 74
install("srp");                                                                                              // 75
install("accounts-password");                                                                                // 76
install("showdown");                                                                                         // 77
install("crosswalk");                                                                                        // 78
install("reactive-dict");                                                                                    // 79
install("session");                                                                                          // 80
install("cfs:standard-packages");                                                                            // 81
install("cfs:base-package");                                                                                 // 82
install("livedata");                                                                                         // 83
install("mongo-livedata");                                                                                   // 84
install("raix:eventemitter");                                                                                // 85
install("cfs:storage-adapter");                                                                              // 86
install("cfs:filesystem");                                                                                   // 87
install("webapp");                                                                                           // 88
install("hot-code-push");                                                                                    // 89
install("fastclick");                                                                                        // 90
install("mobile-status-bar");                                                                                // 91
install("spacebars");                                                                                        // 92
...
install("url");                                                                                              // 97
install("http");                                                                                             // 98
install("cfs:data-man");                                                                                     // 99
install("cfs:file");                                                                                         // 100
install("cfs:tempstore");                                                                                    // 101
install("cfs:http-methods");                                                                                 // 102
install("cfs:http-publish");                                                                                 // 103
install("cfs:access-point");                                                                                 // 104
install("cfs:reactive-property");                                                                            // 105
install("cfs:reactive-list");                                                                                // 106
install("cfs:power-queue");                                                                                  // 107
install("cfs:upload-http");                                                                                  // 108
install("cfs:collection");                                                                                   // 109
install("cfs:collection-filters");                                                                           // 110
install("cfs:worker");                                                                                       // 111
install("autoupdate");                                                                                       // 112
install("service-configuration");                                                                            // 113
                                                                                                             // 114
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
