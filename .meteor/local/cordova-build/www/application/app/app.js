...
Template["index"] = new Template("Template.index", (function() {                                                 // 3
  ...
  return [ Blaze.If(function() {                                                                                 // 5
    ...
    return [ "\n        ", HTML.DIV({                                                                            // 38
      ...
      "class": "col-xs-3 "                                                                                       // 41
    }, "\n                ", HTML.H2("\n                    ", Blaze.View("lookup:user.username", function() {   // 42
      return Spacebars.mustache(Spacebars.dot(view.lookup("user"), "username"));                                 // 43
    }), " :\n                "), "\n            "), "\n            ", HTML.DIV({                                 // 44
      "class": "col-xs-3 "                                                                                       // 45
    }, HTML.BUTTON({                                                                                             // 46
      id: "addFriend",                                                                                           // 47
      ...
      id: "likePost",                                                                                            // 52
      "class": "btn btn-info col-xs-3"                                                                           // 53
    }, "点赞(", Blaze.View("lookup:like", function() {                                                             // 54
      return Spacebars.mustache(view.lookup("like"));                                                            // 55
    }), ")")), "\n        "), "\n            ", HTML.P({                                                         // 56
      "class": "muted"                                                                                           // 57
    }, Blaze.View("lookup:time", function() {                                                                    // 58
      return Spacebars.mustache(view.lookup("time"));                                                            // 59
    })), "\n            ", HTML.P(Spacebars.include(view.lookupTemplate("markdown"), function() {                // 60
      return Blaze.View("lookup:post", function() {                                                              // 61
        return Spacebars.mustache(view.lookup("post"));                                                          // 62
      });                                                                                                        // 63
      ...
      return [ "\n                ", HTML.P("\n                ", HTML.INPUT({                                   // 67
        ...
        "class": "span8",                                                                                        // 69
        id: function() {                                                                                         // 70
          return Spacebars.mustache(Spacebars.dot(view.lookup("."), "_id"));                                     // 71
        }                                                                                                        // 72
      }), "\n                ", HTML.BUTTON({                                                                    // 73
        id: "commnetSubmit",                                                                                     // 74
        "class": "btn btn-success"                                                                               // 75
      }, "评论"), "\n                "), "\n            " ];                                                       // 76
    }), "\n            ", Blaze.Each(function() {                                                                // 77
      return Spacebars.call(view.lookup("comments"));                                                            // 78
    }, function() {                                                                                              // 79
      return [ "\n                ", HTML.P(Blaze.View("lookup:user.username", function() {                      // 80
        return Spacebars.mustache(Spacebars.dot(view.lookup("user"), "username"));                               // 81
      }), " 评论: ", Blaze.View("lookup:post", function() {                                                        // 82
        return Spacebars.mustache(view.lookup("post"));                                                          // 83
      })), "\n            " ];                                                                                   // 84
    }), "\n        " ];                                                                                          // 85
  }), "\n    "), "\n    ", HTML.DIV({                                                                            // 86
    "class": "row well center"                                                                                   // 87
  }, "\n        ", Blaze.Each(function() {                                                                       // 88
    return Spacebars.call(view.lookup("posts"));                                                                 // 89
  }, function() {                                                                                                // 90
    return [ "\n        ", HTML.DIV({                                                                            // 91
      "class": "well"                                                                                            // 92
    }, "\n            ", HTML.DIV("\n                ", HTML.H2({                                                // 93
      ...
      id: "addFriend",                                                                                           // 98
      "class": "btn btn-primary col-xs-3 pull-right"                                                             // 99
    }, "加好友"), "\n            ", HTML.BUTTON({                                                                   // 100
      id: "likePost",                                                                                            // 101
      "class": "btn btn-info col-xs-3 pull-right"                                                                // 102
    }, "点赞(", Blaze.View("lookup:like", function() {                                                             // 103
      return Spacebars.mustache(view.lookup("like"));                                                            // 104
    }), ")"), "\n        "), "\n            ", HTML.P({                                                          // 105
      "class": "muted"                                                                                           // 106
    }, Blaze.View("lookup:time", function() {                                                                    // 107
      return Spacebars.mustache(view.lookup("time"));                                                            // 108
    })), "\n            ", HTML.P(Spacebars.include(view.lookupTemplate("markdown"), function() {                // 109
      return Blaze.View("lookup:post", function() {                                                              // 110
        return Spacebars.mustache(view.lookup("post"));                                                          // 111
      });                                                                                                        // 112
    })), "\n            ", Blaze.If(function() {                                                                 // 113
      return Spacebars.call(view.lookup("currentUser"));                                                         // 114
    }, function() {                                                                                              // 115
      return [ "\n                ", HTML.P("\n                ", HTML.INPUT({                                   // 116
        type: "text",                                                                                            // 117
        "class": "span8",                                                                                        // 118
        id: function() {                                                                                         // 119
          return Spacebars.mustache(Spacebars.dot(view.lookup("."), "_id"));                                     // 120
        }                                                                                                        // 121
      }), "\n                ", HTML.BUTTON({                                                                    // 122
        id: "commnetSubmit",                                                                                     // 123
        "class": "btn btn-success"                                                                               // 124
      }, "评论"), "\n                "), "\n            " ];                                                       // 125
    }), "\n            ", Blaze.Each(function() {                                                                // 126
      return Spacebars.call(view.lookup("comments"));                                                            // 127
    }, function() {                                                                                              // 128
      return [ "\n                ", HTML.P(Blaze.View("lookup:user.username", function() {                      // 129
        return Spacebars.mustache(Spacebars.dot(view.lookup("user"), "username"));                               // 130
      }), " 评论: ", Blaze.View("lookup:post", function() {                                                        // 131
        return Spacebars.mustache(view.lookup("post"));                                                          // 132
      })), "\n            " ];                                                                                   // 133
    }), "\n        " ];                                                                                          // 134
  }), "\n    ") ];                                                                                               // 135
}));                                                                                                             // 136
